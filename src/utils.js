...
export const categoriesEng = ['Arts', 'Automobiles', 'Books', 'Business', 'Fashion', 'Food', 'Health', 'Front Page', 'Insider', 'Magazine', 'Movies', 'N.Y. Region', 'Obituaries', 'Opinion', 'Politics', 'Real Estate', 'Science', 'Sports', 'Sunday Review', 'Technology', 'Theater', 'Times Magazine', 'Travel', 'Upshot', 'U.S.', 'World']
